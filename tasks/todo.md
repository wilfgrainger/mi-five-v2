...
- [ ] Evaluate `src/App.tsx` and UI for a "Kids to Adults" scalable gameplay feel. Ensure proper onboarding flow and no missing states (e.g. unhandled API rejections).
